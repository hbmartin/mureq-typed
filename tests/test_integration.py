...
class MureqIntegrationTestCase(unittest.TestCase):
    ...
    def test_request(self):
        result = self._get_json(
            mureq.request("GET", "https://httpbingo.org/get", timeout=10.0)
        )
        self.assertEqual(result["headers"]["User-Agent"], [mureq.DEFAULT_UA])
        self.assertEqual(result["url"], "https://httpbingo.org/get")
    ...
    def test_yield_response(self):
        with mureq.yield_response("GET", "https://httpbingo.org/get") as response:
            ...
            self.assertEqual(
                json.loads(response.read())["url"], "https://httpbingo.org/get"
            )
    ...
    def test_query_params(self):
        ...
        result = self._get_json(
            mureq.get("https://httpbingo.org/get", params={"a": "b"})
        )
        self.assertEqual(result["url"], "https://httpbingo.org/get?a=b")
        self.assertEqual(result["args"], {"a": ["b"]})
        ...
        result = self._get_json(
            mureq.get("https://httpbingo.org/get?a=b", params={"c": "d"})
        )
    ...
    def test_put(self):
        result = self._get_json(
            mureq.put("https://httpbingo.org/put", body=b"strawberry")
        )
        self.assertEqual(result["headers"]["User-Agent"], [mureq.DEFAULT_UA])
    ...
    def test_patch(self):
        result = self._get_json(
            mureq.patch("https://httpbingo.org/patch", body=b"burrito")
        )
        self.assertEqual(result["headers"]["User-Agent"], [mureq.DEFAULT_UA])
    ...
    def test_form(self):
        result = self._get_json(
            mureq.post("https://httpbingo.org/post", form={"a": "1"})
        )
        self.assertEqual(
    ...
    def test_307(self):
        response = mureq.get(
            "https://httpbingo.org/redirect-to?url=/get&status_code=307"
        )
        self.assertEqual(response.status_code, 307)
        self.assertEqual(response.headers["Location"], "/get")
        self.assertEqual(
            response.url, "https://httpbingo.org/redirect-to?url=/get&status_code=307"
        )
        ...
        response = mureq.get(
            "https://httpbingo.org/redirect-to?url=/post&status_code=307",
            max_redirects=1,
        )
        self.assertEqual(response.status_code, 405)
    ...
    def test_303(self):
        ...
        response = mureq.post(
            "https://httpbingo.org/redirect-to?url=/post&status_code=303", body=b"xyz"
        )
        self.assertEqual(response.status_code, 303)
        self.assertEqual(
            response.url, "https://httpbingo.org/redirect-to?url=/post&status_code=303"
        )

        response = mureq.post(
            "https://httpbingo.org/redirect-to?url=/post&status_code=303",
            body=b"xyz",
            max_redirects=1,
        )
        ...
        response = mureq.post(
            "https://httpbingo.org/redirect-to?url=/get&status_code=303",
            body=b"xyz",
            max_redirects=1,
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_read_limit(self):
        response = mureq.get(
            "https://httpbingo.org/get", headers={"X-Test-1": "porcupine"}
        )
...
class MureqIntegrationIPAddressURLTestCase(unittest.TestCase):
    ...
    def test_ipv6_url(self):
        ...
        self.assertEqual(
            mureq.get(https_url, headers=headers, verify=False).status_code, 200
        )
        self.assertEqual(
            mureq.get(https_url_port, headers=headers, verify=False).status_code, 200
        )
