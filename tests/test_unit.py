...
class RedirectTestCase(unittest.TestCase):
    ...
    def test_200(self):
        self.assertEqual(
            _check_redirect(
                "https://www.google.com/", 200, {"Location": "https://www.bing.com"}
            ),
            None,
        )
    ...
    def test_302_no_header(self):
        self.assertEqual(
            _check_redirect(
                ...
                302,
                {"X-Location": "https://www.google.com/search"},
            ),
            None,
        )
    ...
    def test_302_relative_slash(self):
        self.assertEqual(
            _check_redirect("https://www.google.com/", 302, {"Location": "/search"}),
            "https://www.google.com/search",
        )
        self.assertEqual(
            _check_redirect("https://www.google.com/baz", 302, {"Location": "/search"}),
            "https://www.google.com/search",
        )
        self.assertEqual(
            _check_redirect(
                "https://www.google.com/baz/", 302, {"Location": "/search"}
            ),
            "https://www.google.com/search",
        )
    ...
    def test_302_relative_noslash(self):
        ...
        self.assertEqual(
            _check_redirect("https://www.google.com/baz/", 302, {"Location": "search"}),
            "https://www.google.com/baz/search",
        )
        self.assertEqual(
            _check_redirect(
                "https://www.google.com/baz/", 302, {"Location": "search/"}
        ...
        self.assertEqual(
            _check_redirect(
                "https://www.google.com/baz/qux", 302, {"Location": "search/"}
            ),
            "https://www.google.com/baz/search/",
        )
